...
export const createComment = (teamId, commentObj) =>
    fetch(`${COMMENTS_URL}/team/${teamId}/comments`, {
        method: "POST",
...
export const findCommentsByTeamId = (teamId) =>
    fetch(`${COMMENTS_URL}/teams/${teamId}/comments`).then(response => response.json())

export const findCommentsById = (commentId) =>
    fetch(`${COMMENTS_URL}/comments/${commentId}`).then(response => response.json())

export default {
    createComment, deleteComment, updateComment, findCommentsByUserName, findCommentsByTeamId, findCommentsById
}